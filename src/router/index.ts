...
export const asyncRoutes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'Seckill',
        component: () =>
          import('@/views/marketing/seckill.vue'),
      ...
      },
      {
        ...
        name: 'GroupBuy',
        component: () =>
          import('@/views/marketing/group.vue'),
      ...
      },
      {
        ...
        name: 'Coupon',
        component: () =>
          import('@/views/marketing/coupon.vue'),
      ...
      },
      {
        ...
        name: 'FullReduction',
        component: () =>
          import('@/views/marketing/full-reduction.vue'),
      ...
      },
      {
        ...
        name: 'Distribution',
        component: () =>
          import('@/views/marketing/distribution.vue'),
      ...
      },
      {
        ...
        name: 'Live',
        component: () =>
          import('@/views/marketing/live.vue'),
      ...
      },
      {
        ...
        name: 'MemberDetail',
        component: () =>
          import('@/views/member/detail.vue'),
        meta: {
          title: '会员详情',
          icon: 'User',
          hidden: true,
